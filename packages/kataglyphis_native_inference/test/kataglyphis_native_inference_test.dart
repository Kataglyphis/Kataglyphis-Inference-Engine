...
void main() {
  final KataglyphisNativeInferencePlatform initialPlatform =
      KataglyphisNativeInferencePlatform.instance;

  test('$MethodChannelKataglyphisNativeInference is the default instance', () {
    expect(
      initialPlatform,
      isInstanceOf<MethodChannelKataglyphisNativeInference>(),
    );
  });

  test('getPlatformVersion', () async {
    KataglyphisNativeInference kataglyphisNativeInferencePlugin =
        KataglyphisNativeInference();
    MockKataglyphisNativeInferencePlatform fakePlatform =
        MockKataglyphisNativeInferencePlatform();
